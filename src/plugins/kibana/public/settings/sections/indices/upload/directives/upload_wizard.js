...
require('plugins/kibana/settings/sections/indices/add_data_steps/parse_csv_step');
require('plugins/kibana/settings/sections/indices/add_data_steps/pipeline_setup');
require('plugins/kibana/settings/sections/indices/add_data_steps/upload_data_step');
