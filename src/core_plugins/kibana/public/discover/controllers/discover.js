...
import { kueryASTUtils, toKueryExpression, fromKueryExpression } from 'ui/kuery';
...
function discoverController($scope, config, courier, $route, $window, Notifier,
  ...
  $scope.filterQuery = function (field, values, operation) {
    ...
    if ($state.query.language === 'kuery') {
      ...
      const newAST = kueryASTUtils.addNode(
        kueryAST,
        kueryASTUtils.buildMatchNode({ field: field.name, values, operation })
      );
